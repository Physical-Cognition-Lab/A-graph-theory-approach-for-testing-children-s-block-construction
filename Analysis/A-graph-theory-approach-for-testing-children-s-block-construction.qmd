...
data <- data %>%
  select(ID_id, Task_model_type, Task_correct_final_ci, Task_onset, Task_offset,  Construct_Action_onset, Construct_Action_offset, Construct_Action_action_cd, Perspective_Orienting_onset, Perspective_Orienting_offset, Perspective_Orienting_direction_lr, view1, view2, view3, view4, below1, below2, below3, below4)
```
...
adult_data_combined <- bind_rows(data_moves_list)

# Save to CSV
write.csv(adult_data_combined, "combined_adult_data.csv", row.names = FALSE)
```

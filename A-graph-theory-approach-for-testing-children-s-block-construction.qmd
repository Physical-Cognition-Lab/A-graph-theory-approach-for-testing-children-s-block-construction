...
Here I want to get the data into columns called view1-4 and below1-4 where view 1 is the string for the move they did, and the rest are how that string would be expressed from different viewpoints. This is important because when they start moving the model round, we want to be able to account for the move from any view.
